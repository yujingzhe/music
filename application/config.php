...
return [
    ...
    // 视图输出字符串内容替换
    'view_replace_str' => [
         ' __STATIC__ '  =>    '/public/static',          //静态资源存放目录
         ' __PUBLIC__ '  =>    '/public',          //静态资源存放目录
         ' __VENDOR__ '  =>    '/../vemdor',          //静态资源存放目录
         '__ROOT_PATH__' =>    'www.tp5admin.com',
    ],
    // 默认跳转页面对应的模板文件
     ...
     */
/*    'qiniu' => [
        'accesskey' => 'I_kR8eixBGN9dyE9YWQUBQGAJt4VykmFBHdazoaa',
